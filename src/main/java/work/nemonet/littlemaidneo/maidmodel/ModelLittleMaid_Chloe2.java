...
public class ModelLittleMaid_Chloe2 extends ModelLittleMaidBase {
    ...
    public ModelLittleMaid_Chloe2() { this(0F); }
    public ModelLittleMaid_Chloe2(float psize) { this(psize, 0F, 128, 64); }
    ...
    public void initModel(float psize, float pyoffset) {
        ...
        bipedBody.setTextureOffset(20, 26).addBox(-3F, -7.5F, -2.1F, 6, 8, 4, psize);
        bipedBody.setTextureOffset(24, 16).addBox(-1F, -8.8F, -1F, 2, 2, 2, psize + 0.5F);
    ...
    public void setLivingAnimations(IModelCaps pEntityCaps, float f, float f1, float pRenderPartialTicks) {
        ...
        float fwBuf1 = Mth.clamp(velY * 3.2F, -2.0F, 1.0F);
        hemSkirtR1.rotationPointY += fwBuf1;
        hemSkirtL1.rotationPointY += fwBuf1;
        float fwBuf2 = Mth.clamp(velY * 6.3F, -3.0F, 1.0F);
    ...
    public void setRotationAngles(float f, float f1, float ticksExisted, float pheadYaw, float pheadPitch, float f5, IModelCaps pEntityCaps) {
        ...
        if (isRiding) {
            ...
            if (isSneak) {
                ...
                float f15 = mh_sin(f * 0.6767F);
                float f16 = mh_cos(f * 0.6767F);
                ...
                float f15 = mh_sin(f * 0.5050F);
                float f16 = mh_cos(f * 0.5050F);
                float f22 = f15 > f16 ? f15 : f16;
                float f35 = f15 < f16 ? f15 : f16;
