...
public class ModelBox extends ModelBoxBase {
    ...
    private void init(ModelRenderer pMRenderer, int pTexX, int pTexY,
        ...
        pX -= pSize; pY -= pSize; pZ -= pSize;
        lx += pSize; ly += pSize; lz += pSize;

        if (pMRenderer.mirror) {
            float var14 = lx; lx = pX; pX = var14;
        }
        ...
        vertexPositions[0] = lxyz; vertexPositions[1] = lwyz;
        vertexPositions[2] = lwhz; vertexPositions[3] = lxhz;
        vertexPositions[4] = lxyd; vertexPositions[5] = lwyd;
        vertexPositions[6] = lwhd; vertexPositions[7] = lxhd;
