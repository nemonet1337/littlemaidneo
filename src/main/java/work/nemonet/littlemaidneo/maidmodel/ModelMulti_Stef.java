...
public class ModelMulti_Stef extends ModelMulti_Steve {
    ...
    public ModelMulti_Stef() { super(); }
    public ModelMulti_Stef(float psize) { super(psize); }
    ...
    public void initModel(float psize, float pyoffset) {
        ...
        bust.addBox(-4F, -2F, -2F, 8, 4, 4, psize);
    ...
    @Override
    public String getUsingTexture() { return "Crafter"; }
