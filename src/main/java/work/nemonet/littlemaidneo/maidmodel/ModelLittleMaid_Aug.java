...
public class ModelLittleMaid_Aug extends ModelLittleMaid_SR2 {
    ...
    public ModelLittleMaid_Aug() { super(); }
    public ModelLittleMaid_Aug(float psize) { super(psize); }
    ...
    public void initModel(float psize, float pyoffset) {
        ...
        bipedHead.setTextureOffset( 0,  0).addParts(ModelBox.class, -4F, -8F, -4F, 8, 8, 8, psize);
        bipedHead.setTextureOffset( 0, 18).addParts(ModelBox.class, -5F, -8.5F, 0.2F, 1, 3, 3, psize);
        bipedHead.setTextureOffset(24, 18).addParts(ModelBox.class, 4F, -8.5F, 0.2F, 1, 3, 3, psize);
        bipedHead.setTextureOffset(52, 10).addParts(ModelBox.class, -7.5F, -9.5F, 0.9F, 4, 3, 2, psize);
        bipedHead.setTextureOffset(52, 15).addParts(ModelBox.class, 3.5F, -9.5F, 0.9F, 4, 3, 2, psize);
