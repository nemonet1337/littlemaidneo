...
public class TargetingSystem {
    ...
    public static class EntityWrapper {
        ...
        public boolean isTargeting(EntityWrapper target) {
            if (this.entity instanceof net.minecraft.world.entity.Mob mobEntity) {
        ...
        public boolean isAttackedBy(EntityWrapper attacker) {
            ...
            return entity.tickCount - TargetingConfig.getAttackedByValidTicks() < entity.getLastHurtByMobTimestamp()
                    && entity.getLastHurtByMob() == attacker.entity;
        }
    ...
    public static class Mob extends EntityWrapper {
        ...
        public Mob(net.minecraft.world.entity.Mob mob) {
            super(mob);
            this.mob = mob;
        }
     ...
     */
    public static Optional<net.minecraft.world.entity.Mob> selectTarget(
