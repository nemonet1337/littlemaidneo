...
public class ResourceHelper {
    ...
    public static ResourceLocation getLocation(String packName, String fileName) {
        ...
        // 1.21.1: ResourceLocationコンストラクタがprivateになったため、ファクトリメソッドを使用
        return ResourceLocation.fromNamespaceAndPath("littlemaidmodelloader", packName + "/" + fileName);
    }
    ...
    public static ResourceLocation getLocation(String prefix, String packName, String fileName) {
        ...
        fileName = fileName.toLowerCase().replaceAll("[^a-z0-9/._\\-]", "-");
        // 1.21.1: ResourceLocationコンストラクタがprivateになったため、ファクトリメソッドを使用
        return ResourceLocation.fromNamespaceAndPath("littlemaidmodelloader", prefix + "/" + packName + "/" + fileName);
    }
