...
public abstract class ModelLittleMaidBase extends ModelMultiMMMBase {
    ...
    public ModelLittleMaidBase() { super(); }
    public ModelLittleMaidBase(float psize) { super(psize); }
    ...
    public void initModel(float psize, float pyoffset) {
        ...
        bipedHead.setTextureOffset(24,  0).addBox(-4F, 0F, 1F, 8, 4, 3, psize);
        bipedHead.setTextureOffset(24, 18).addBox(-5F, -7F, 0.2F, 1, 3, 3, psize);
        bipedHead.setTextureOffset(24, 18).addBox(4F, -7F, 0.2F, 1, 3, 3, psize);
        bipedHead.setTextureOffset(52, 10).addBox(-2F, -7.2F, 4F, 4, 4, 2, psize);
        bipedHead.setTextureOffset(46, 20).addBox(-1.5F, -6.8F, 4F, 3, 9, 3, psize);
        bipedHead.setTextureOffset(58, 21).addBox(-5.5F, -6.8F, 0.9F, 1, 8, 2, psize);
        bipedHead.setMirror(true);
        bipedHead.setTextureOffset(58, 21).addBox(4.5F, -6.8F, 0.9F, 1, 8, 2, psize);
    ...
    @Override
    public float[] getArmorModelsSize() { return new float[]{0.1F, 0.5F}; }
    ...
    @Override
    public float getyOffset() { return getHeight() * 0.9F; }
    ...
    public float lerp(float delta, float a, float b) { return delta * (b - a) + a; }
    ...
    public void setRotationAngles(float par1, float par2, float pTicksExisted,
        ...
        if ((onGrounds[0] > -9990F || onGrounds[1] > -9990F) && !aimedBow) {
            ...
            if (onGrounds[0] > 0F) {
                f6 = 1.0F - onGrounds[0]; f6 *= f6; f6 *= f6; f6 = 1.0F - f6;
    ...
    public int showArmorParts(int parts, int index) {
        ...
        Skirt.setVisible(parts == 1);
        boolean leg = parts == 0;
        bipedRightLeg.setVisible(leg);
        bipedLeftLeg.setVisible(leg);
        return -1;
    }
