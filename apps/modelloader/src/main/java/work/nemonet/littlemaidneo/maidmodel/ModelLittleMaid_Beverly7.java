...
public class ModelLittleMaid_Beverly7 extends ModelLittleMaidBase {
    ...
    public void initModel(float psize, float pyoffset) {
        ...
        bipedHead.setTextureOffset(72, 0).addBox(-2F, -7.2F, 4F, 4, 4, 2, psize);
        bipedHead.setTextureOffset(56, 0).addBox(-5F, -7F, 0.2F, 1, 3, 3, psize);
        bipedHead.setMirror(true);
        bipedHead.setTextureOffset(64, 0).addBox(4F, -7F, 0.2F, 1, 3, 3, psize);
        ...
        bipedRightArm = new ModelRenderer(this, 0, 25);
        ...
        upperRightArm = new ModelRenderer(this, 0, 16);
        ...
        bipedRightLeg = new ModelRenderer(this, 0, 47);
        ...
        upperRightLeg = new ModelRenderer(this, 0, 36);
        ...
        bipedBody.setTextureOffset(20, 26).addBox(-3F, -8.5F, -2.1F, 6, 9, 4, psize);
        bipedBody.setTextureOffset(24, 16).addBox(-1F, -9.8F, -1F, 2, 2, 2, psize + 0.5F);
    ...
    @Override
    public float getHeight() { return 1.99F; }
    ...
    public void setLivingAnimations(IModelCaps pEntityCaps, float f, float f1, float pRenderPartialTicks) {
        ...
        eyeR.setRotationPoint(0F, 0F, 0F); eyeL.setRotationPoint(0F, 0F, 0F);
        ...
        hemSkirtR1.setRotationPoint(-2F, 3F, 2F); hemSkirtL1.setRotationPoint(2F, 3F, 2F);
        hemSkirtR2.setRotationPoint(0F, 6F, -1F); hemSkirtL2.setRotationPoint(0F, 6F, -1F);
        ...
        bipedHead.rotateAngleX = 0F; bipedHead.rotateAngleY = 0F; bipedHead.rotateAngleZ = 0F;
        Ponytail.rotateAngleX = 0.05F; Ponytail.rotateAngleY = 0F; Ponytail.rotateAngleZ = 0F;
        ...
        upperRightArm.rotateAngleX = 0F; upperRightArm.rotateAngleY = 0F; upperRightArm.rotateAngleZ = 0F;
        ...
        upperLeftArm.rotateAngleX = 0F; upperLeftArm.rotateAngleY = 0F; upperLeftArm.rotateAngleZ = 0F;
        ...
        upperRightLeg.rotateAngleX = -0.05F; upperRightLeg.rotateAngleY = 0.05F; upperRightLeg.rotateAngleZ = -0.05F;
        bipedRightLeg.rotateAngleX = 0.05F; bipedRightLeg.rotateAngleY = -0.1F; bipedRightLeg.rotateAngleZ = 0.02F;
        upperLeftLeg.rotateAngleX = -0.05F; upperLeftLeg.rotateAngleY = -0.05F; upperLeftLeg.rotateAngleZ = 0.05F;
        bipedLeftLeg.rotateAngleX = 0.05F; bipedLeftLeg.rotateAngleY = 0.1F; bipedLeftLeg.rotateAngleZ = -0.02F;

        Skirt.rotateAngleX = 0F; Skirt.rotateAngleY = 0F; Skirt.rotateAngleZ = 0F;
        hemSkirtR1.rotateAngleX = 0F; hemSkirtR1.rotateAngleY = 0F; hemSkirtR1.rotateAngleZ = 0.05F;
        hemSkirtL1.rotateAngleX = 0F; hemSkirtL1.rotateAngleY = 0F; hemSkirtL1.rotateAngleZ = -0.05F;
        hemSkirtR2.rotateAngleX = 0F; hemSkirtR2.rotateAngleY = 0F; hemSkirtR2.rotateAngleZ = -0.03F;
        hemSkirtL2.rotateAngleX = 0F; hemSkirtL2.rotateAngleY = 0F; hemSkirtL2.rotateAngleZ = 0.03F;

        bipedBody.rotateAngleX = -0.1F; bipedBody.rotateAngleY = 0F; bipedBody.rotateAngleZ = 0F;
        breastR.rotateAngleX = 0.785F; breastR.rotateAngleY = 0F; breastR.rotateAngleZ = -0.15F;
        breastL.rotateAngleX = 0.785F; breastL.rotateAngleY = 0F; breastL.rotateAngleZ = 0.15F;
        ...
        if (f4 < 0) { eyeR.setVisible(true); eyeL.setVisible(true); }
        else { eyeR.setVisible(false); eyeL.setVisible(false); }

        float legSlideDelay = idTicks % 2011 - 2000;
        legSlideDelay = legSlideDelay < 0 ? 0F : legSlideDelay / 10;
        if (idTicks % 4022 < 2011) { legSlideDelay = 1 - legSlideDelay; }
        ...
        hemSkirtR1.rotationPointY += fwBuf1; hemSkirtL1.rotationPointY += fwBuf1;
        float fwBuf2 = Mth.clamp(velY * 6.3F, -3F, 1F);
        hemSkirtR2.rotationPointY += fwBuf2; hemSkirtL2.rotationPointY += fwBuf2;
    ...
    public void setRotationAngles(float f, float f1, float ticksExisted, float pheadYaw, float pheadPitch, float f5, IModelCaps pEntityCaps) {
        ...
        if (isRiding) {
            ...
            if (ridingEntity instanceof Player || ridingEntity instanceof IMultiModel) {
                bipedRightArm.rotateAngleX -= 1.3F; bipedLeftArm.rotateAngleX -= 1.3F;
                upperRightLeg.rotateAngleX -= 1.1F; upperLeftLeg.rotateAngleX -= 1.1F;
                bipedRightLeg.rotateAngleX += 0.9F; bipedLeftLeg.rotateAngleX += 0.9F;
                upperRightLeg.rotateAngleY += 0.3F; upperLeftLeg.rotateAngleY -= 0.3F;
                mainFrame.rotationPointY += 12F; mainFrame.rotationPointZ += 1F;
            } else if (ridingEntity instanceof Animal) {
                bipedRightArm.rotateAngleX -= 1.3F; bipedLeftArm.rotateAngleX -= 1.3F;
                upperRightLeg.rotateAngleX -= 1.0F; upperLeftLeg.rotateAngleX -= 1.0F;
                bipedRightLeg.rotateAngleX += 1.0F; bipedLeftLeg.rotateAngleX += 1.0F;
                upperRightLeg.rotateAngleY += 0.3F; upperLeftLeg.rotateAngleY -= 0.3F;
                mainFrame.rotationPointY += 4F; mainFrame.rotationPointZ += 1F;
            } else {
                upperRightArm.rotateAngleX -= 0.1F; upperLeftArm.rotateAngleX -= 0.1F;
                upperRightLeg.rotateAngleX -= 1.3F; upperLeftLeg.rotateAngleX -= 1.3F;
                bipedRightLeg.rotateAngleX += 2.5F; bipedLeftLeg.rotateAngleX += 2.5F;
                mainFrame.rotationPointY += 4F; mainFrame.rotationPointZ += 1F;
                if (!isWait) {
                    mainFrame.rotateAngleY += 0.7F;
                    bipedHead.rotateAngleY -= 0.7F;
                    if (bipedHead.rotateAngleY < -1.5F) bipedHead.rotateAngleY = -1.5F;
                    bipedRightLeg.rotateAngleX -= 0.5F; bipedLeftLeg.rotateAngleX -= 0.5F;
                    upperRightLeg.rotateAngleY += 0.3F; upperLeftLeg.rotateAngleY += 0.3F;
                    bipedRightLeg.rotateAngleY += 0.2F; bipedLeftLeg.rotateAngleY += 0.2F;
                    bipedBody.rotateAngleY += 0.3F; hipBody.rotateAngleY += 0.3F;
                    hemSkirtR1.rotationPointX += 2F; hemSkirtL1.rotationPointX += 2F;
                    hemSkirtR2.rotationPointZ -= 1F; hemSkirtL2.rotationPointZ -= 1F;
                }
            }
        } else {
            if (isSneak || !ModelCapsHelper.getCapsValueBoolean(pEntityCaps, caps_PosBlockAir, 0D, 2D, 0D)) {
                if (isWait) {
                    upperRightLeg.rotateAngleX -= 0.1F; upperLeftLeg.rotateAngleX -= 0.2F;
                    bipedRightLeg.rotateAngleX += 1.7F; bipedLeftLeg.rotateAngleX += 1.8F;
                    mainFrame.rotationPointY += 6F;
                } else {
                    bipedBody.rotateAngleX += 0.7F;
                    hipBody.rotateAngleX -= 0.1F + mh_sin(ticksExisted * 0.057F) * 0.03F;
                    upperRightArm.rotateAngleX += 0.1F; upperLeftArm.rotateAngleX += 0.1F;
                    upperRightLeg.rotateAngleY -= 0.07F; upperLeftLeg.rotateAngleY += 0.07F;
                    upperRightLeg.rotateAngleX -= 0.37F; upperLeftLeg.rotateAngleX -= 0.32F;
                    bipedRightLeg.rotateAngleX += 0.32F; bipedLeftLeg.rotateAngleX += 0.22F;
                    mainFrame.rotationPointY += 0.4F;
                }
                float f15 = mh_sin(f * 0.6565F);
                float f16 = mh_cos(f * 0.6565F);
                float f22 = f15 > f16 ? f15 : f16;
                float f35 = f15 < f16 ? f15 : f16;
                upperRightArm.rotateAngleX -= f15 * 0.2F * f1; upperLeftArm.rotateAngleX += f15 * 0.2F * f1;
                bipedRightArm.rotateAngleX -= f22 * 0.7F * f1; bipedLeftArm.rotateAngleX += f35 * 0.7F * f1;
                upperRightLeg.rotateAngleX += f15 * 0.2F * f1; upperLeftLeg.rotateAngleX -= f15 * 0.2F * f1;
                bipedRightLeg.rotateAngleX += f22 * 0.7F * f1; bipedLeftLeg.rotateAngleX -= f35 * 0.7F * f1;
                ...
                float f15 = mh_sin(f * 0.4444F);
                float f16 = mh_cos(f * 0.4444F);
                float f22 = f15 > f16 ? f15 : f16;
                float f35 = f15 < f16 ? f15 : f16;
                upperRightArm.rotateAngleX -= f15 * 0.7F * f1; upperLeftArm.rotateAngleX += f15 * 0.7F * f1;
                bipedRightArm.rotateAngleX -= f22 * 0.7F * f1; bipedLeftArm.rotateAngleX += f35 * 0.7F * f1;
                upperRightLeg.rotateAngleX += f15 * 0.9F * f1; upperLeftLeg.rotateAngleX -= f15 * 0.9F * f1;
                bipedRightLeg.rotateAngleX += f22 * 0.9F * f1; bipedLeftLeg.rotateAngleX -= f35 * 0.9F * f1;
        ...
        if (isWait) {
            ...
            breastR.rotationPointX += 0.1F; breastL.rotationPointX -= 0.1F;
        } else {
            if (aimedBow) {
                float f6 = mh_sin(onGround * 3.141593F);
                float f7 = mh_sin((1.0F - (1.0F - onGround) * (1.0F - onGround)) * 3.141593F);
                upperRightArm.rotateAngleZ = 0.0F; upperLeftArm.rotateAngleZ = 0.0F;
                upperRightArm.rotateAngleY = -(0.1F - f6 * 0.6F);
                upperLeftArm.rotateAngleY = 0.1F - f6 * 0.6F;
                upperRightArm.rotateAngleX = -1.470796F; upperLeftArm.rotateAngleX = -1.470796F;
                ...
                upperRightArm.rotateAngleZ += 0.2F; upperLeftArm.rotateAngleZ -= 0.2F;
                bipedRightArm.rotateAngleZ += 0.05F; bipedLeftArm.rotateAngleZ -= 0.05F;
                upperRightArm.rotateAngleZ += mh_cos(ticksExisted * 0.08F) * 0.03F + 0.05F;
                upperLeftArm.rotateAngleZ -= mh_cos(ticksExisted * 0.08F) * 0.03F + 0.05F;
                upperRightArm.rotateAngleX += mh_sin(ticksExisted * 0.057F) * 0.05F;
                upperLeftArm.rotateAngleX -= mh_sin(ticksExisted * 0.057F) * 0.05F;
