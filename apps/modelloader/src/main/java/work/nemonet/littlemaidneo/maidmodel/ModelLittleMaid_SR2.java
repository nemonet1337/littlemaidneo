...
public class ModelLittleMaid_SR2 extends LMModel<MultiModelRenderState> {

    public ModelLittleMaid_SR2() { this(0.0F); }
    public ModelLittleMaid_SR2(float psize) { this(psize, 0.0F); }
    public ModelLittleMaid_SR2(float psize, float pyoffset) { this(psize, pyoffset, 64, 32); }

    public ModelLittleMaid_SR2(float psize, float pyoffset, int texW, int texH) {
        super(
