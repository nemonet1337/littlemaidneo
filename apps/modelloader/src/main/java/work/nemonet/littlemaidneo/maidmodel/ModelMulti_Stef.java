...
public class ModelMulti_Stef extends LMModel<MultiModelRenderState> {

    public ModelMulti_Stef() { this(0.0F); }
    public ModelMulti_Stef(float psize) { this(psize, 0.0F); }
    public ModelMulti_Stef(float psize, float pyoffset) { this(psize, pyoffset, 64, 32); }

    public ModelMulti_Stef(float psize, float pyoffset, int texW, int texH) {
        super(
    ...
    private static void buildMesh(MeshDefinition mesh, CubeDeformation deform, float pyoffset) {
        ...
        var bipedBody = bipedTorso.addOrReplaceChild("biped_body", CubeListBuilder.create(), PartPose.offset(0, 0.7F, 0));
        bipedBody.addOrReplaceChild("body_main", CubeListBuilder.create()
                .texOffs(16, 16).addBox(-4, 0.2F, -2, 8, 12, 4, deform), PartPose.offset(0, 0, 0));
        bipedBody.addOrReplaceChild("bust", CubeListBuilder.create()
                .texOffs(16, 21).addBox(-4, -2, -2, 8, 4, 4, deform), PartPose.offset(0, 4.25F, -1.4F));
        ...
        var bipedHead = bipedNeck.addOrReplaceChild("biped_head", CubeListBuilder.create(), PartPose.offset(0, 1.35F, 0));
        ...
        bipedHead.addOrReplaceChild("headwear", CubeListBuilder.create()
                .texOffs(32, 0).addBox(-4, -8, -4, 8, 8, 8, CubeDeformation.NONE.extend(0.3F)), PartPose.offset(0, 0, 0));
        ...
        var bipedRightArm = bipedNeck.addOrReplaceChild("biped_right_arm", CubeListBuilder.create(), PartPose.offset(-4.4F, 2.85F, 0));
        ...
        var bipedLeftArm = bipedNeck.addOrReplaceChild("biped_left_arm", CubeListBuilder.create(), PartPose.offset(4.4F, 2.85F, 0));
        ...
        var bipedRightLeg = bipedPelvic.addOrReplaceChild("biped_right_leg", CubeListBuilder.create(), PartPose.offset(-1.7F, 12.3F, 0));
        ...
        var bipedLeftLeg = bipedPelvic.addOrReplaceChild("biped_left_leg", CubeListBuilder.create(), PartPose.offset(1.7F, 12.3F, 0));
