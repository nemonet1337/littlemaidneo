...
public class ModelMulti_Classic64 extends LMModel<MultiModelRenderState> {

    public ModelMulti_Classic64() { this(0.0F); }
    public ModelMulti_Classic64(float psize) { this(psize, 0.0F); }
    public ModelMulti_Classic64(float psize, float pyoffset) { this(psize, pyoffset, 64, 64); }

    public ModelMulti_Classic64(float psize, float pyoffset, int texW, int texH) {
        super(
