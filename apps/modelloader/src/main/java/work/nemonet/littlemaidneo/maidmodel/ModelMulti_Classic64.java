...
public class ModelMulti_Classic64 extends ModelMultiBase {
    ...
    public ModelMulti_Classic64() { super(); }
    public ModelMulti_Classic64(float psize) { super(psize, 0.0F, 64, 64); }
    ...
    public void setRotationAngles(float par1, float par2, float pTicksExisted,
        ...
        bipedRightArm.rotateAngleX = lf2 * 2.0F * par2 * 0.5F;
        bipedLeftArm.rotateAngleX = lf1 * 2.0F * par2 * 0.5F;
        bipedRightLeg.rotateAngleX = lf1 * 1.4F * par2;
        bipedLeftLeg.rotateAngleX = lf2 * 1.4F * par2;
        ...
        bipedRightArm.rotateAngleZ += lf;
        bipedLeftArm.rotateAngleZ -= lf;
        lf = mh_sin(pTicksExisted * 0.067F) * 0.05F;
        bipedRightArm.rotateAngleX += lf;
        bipedLeftArm.rotateAngleX -= lf;
    }
    ...
    @Override
    public float[] getArmorModelsSize() { return new float[]{0.5F, 1.0F}; }
    ...
    @Override
    public float getyOffset() { return 1.62F; }

    @Override
    public float getMountedYOffset() { return getHeight() * 0.75F; }

    @Override
    public boolean isItemHolder() { return true; }

    @Override
    public float getLeashOffset(IModelCaps pEntityCaps) { return 0.2F; }
